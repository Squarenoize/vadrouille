    ...
    <table class="admin-table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?= htmlspecialchars($tripTypeTranslations[$request->getTripType()] ?? ucfirst($request->getTripType())) ?></td>
                <td><?= htmlspecialchars($destinationTranslations[$request->getDestination()] ?? ucfirst($request->getDestination())) ?></td>
                <td><?= htmlspecialchars($request->getDuration()) ?></td>
                <td><?= htmlspecialchars($request->getCreatedAt()) ?></td>
                <td><?= htmlspecialchars($statusTranslations[$request->getStatus()] ?? ucfirst($request->getStatus())) ?></td>
            </tr>
            <?php endforeach; ?>
        </tbody>
    </table>
